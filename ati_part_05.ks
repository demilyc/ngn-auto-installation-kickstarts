...
part /data --fstype="xfs" --grow --maxsize=280000 --ondisk=/dev/sda
part /config --fstype="xfs" --ondisk=/dev/sda --size=1024
part /logging --fstype="xfs" --ondisk=/dev/sda --size=2048
