...
logvol / --vgname=testgroup3 --size=6000 --name=root --fstype=ext3
logvol swap --vgname=testgroup3 --size=2000 --name=swap
logvol /data --vgname=testgroup --size=10000 --name=data --useexisting
