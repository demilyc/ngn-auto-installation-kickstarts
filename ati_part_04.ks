...
part / --asprimary --fstype="ext4" --ondisk=/dev/sda --size=4300
part /boot --asprimary --fstype="ext4" --ondisk=/dev/sda --size=4300
part swap --asprimary --fstype="swap" --ondisk=/dev/sda --recommended
part /data --fstype="ext4" --grow --maxsize=5120 --ondisk=/dev/sda
part /config --fstype="ext4" --ondisk=/dev/sda --size=5
