...
# 3. set swap partition as primary
...
part / --fstype=ext4 --size=4300 --ondisk=/dev/sda --asprimary
part /boot --fstype=ext4 --size=4300 --ondisk=/dev/sda --asprimary
part swap --fstype=swap --recommended --ondisk=/dev/sda --asprimary
